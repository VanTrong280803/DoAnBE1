...
if (isset($_SESSION['qtyProductInRow_userindex'])) unset($_SESSION['qtyProductInRow_userindex']);
if (isset($_SESSION['sort_userindex'])) unset($_SESSION['sort_userindex']);
...
if (isset($_GET['id'])) {
    $_SESSION['category_usercategory'] = $_GET['id'];
    ...
    $productOfCategoryList = $productModel->getProductInCategoryByPage($page, $perpage, $id);
    $totalPage = ceil($productModel->getTotalProductByCategory($id) / $perpage);
}

if (isset($_SESSION['category_usercategory'])) {
    $id = $_SESSION['category_usercategory'];
    $productModel = new ProductModel();
    ...
    if (isset($_GET['quantityProductInRow'])) {
        $_SESSION['qtyProductInRow_usercategory'] = $_GET['quantityProductInRow'];
    }

    if (isset($_SESSION['qtyProductInRow_usercategory'])) {
        if ($_SESSION['qtyProductInRow_usercategory'] == 2) {
            $perpage = 4;
        } else if ($_SESSION['qtyProductInRow_usercategory'] == 3) {
            $perpage = 6;
        }
    }
    ...
    if (isset($_GET['sort'])) {
        $_SESSION['categorySort_user'] = $_GET['sort'];
        if ($_GET['sort'] == 1) {
            $productOfCategoryList = $productModel->getProductsCategorySortUpFollowPrice($id, $page, $perpage);
        } else if ($_GET['sort'] == 2) {
            $productOfCategoryList = $productModel->getProductsCategorySortDownFollowPrice($id, $page, $perpage);
        } else if ($_GET['sort'] == 3) {
            $productOfCategoryList = $productModel->getProductsCategorySortUpFollowStar($id, $page, $perpage);
        } else if ($_GET['sort'] == 4) {
            $productOfCategoryList = $productModel->getProductsCategorySortDownFollowStar($id, $page, $perpage);
        } else {
            $productOfCategoryList = $productModel->getProductInCategoryByPage($page, $perpage, $id);
        }
    } else if (isset($_SESSION['categorySort_user'])) {
        if ($_SESSION['categorySort_user'] == 1) {
            $productOfCategoryList = $productModel->getProductsCategorySortUpFollowPrice($id, $page, $perpage);
        } else if ($_SESSION['categorySort_user'] == 2) {
            $productOfCategoryList = $productModel->getProductsCategorySortDownFollowPrice($id, $page, $perpage);
        } else if ($_SESSION['categorySort_user'] == 3) {
            $productOfCategoryList = $productModel->getProductsCategorySortUpFollowStar($id, $page, $perpage);
        } else if ($_SESSION['categorySort_user'] == 4) {
            $productOfCategoryList = $productModel->getProductsCategorySortDownFollowStar($id, $page, $perpage);
        } else {
            $productOfCategoryList = $productModel->getProductInCategoryByPage($page, $perpage, $id);
        }
...
<head>
    ...
    <link rel='shortcut icon' href='./assets/img/icon/categories.png'/>
                    ...
                    <ul class="nav-bar-list-item-list">
                        ...
                        <li class="header__navbar-item header__navbar-user">
                            ...
                            <ul class="header__navbar-user-menu">
                                ...
                                <li class="header__navbar-user-item">
                                    <a href="favoriteproduct.php">Favorite</a>
                                </li>
                                <li class="header__navbar-user-item">
                                                    ...
                                                    <li class="header__cart-item">
                                                        ...
                                                        <div class="header__cart-item-info">
                                                            ...
                                                            <div class="header__cart-item-body">
                                                                ...
                                                                <a href="usercategory.php?idDeleteProduct=<?php echo $element['id'] ?>" class="header__cart-item-remove">Delete
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </li>
                    ...
                    <div class="col">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <li><a class="dropdown-item" href="usercategory.php?sort=5">None <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                                            <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
                                        </svg></a></li>
                                <li><a class="dropdown-item" href="usercategory.php?sort=1">Price: low to hight <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z" />
                                        </svg></a></li>
                                <li><a class="dropdown-item" href="usercategory.php?sort=2">Price: hight to low <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z" />
                                        </svg></a></li>
                                <li><a class="dropdown-item" href="usercategory.php?sort=3">Star: low to hight <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z" />
                                        </svg></a></li>
                                <li><a class="dropdown-item" href="usercategory.php?sort=4">Star: hight to low <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z" />
                                        </svg></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="product-style">
                        <div class="product-menu">
                            <div class="row">
                                <div class="col">
                                    <?php
                                    if (isset($_SESSION['qtyProductInRow_usercategory']) && $_SESSION['qtyProductInRow_usercategory'] == 2) {
                                    ?>
                                        <a href="usercategory.php?quantityProductInRow=2" class="btn-view btn-view-2 active"></a>
                                        <a href="usercategory.php?quantityProductInRow=3" class="btn-view btn-view-3"></a>
                                        <a href="usercategory.php?quantityProductInRow=4" class="btn-view btn-view-4"></a>
                                    <?php
                                    } else if (isset($_SESSION['qtyProductInRow_usercategory']) && $_SESSION['qtyProductInRow_usercategory'] == 3) {
                                    ?>
                                        <a href="usercategory.php?quantityProductInRow=2" class="btn-view btn-view-2"></a>
                                        <a href="usercategory.php?quantityProductInRow=3" class="btn-view btn-view-3 active"></a>
                                        <a href="usercategory.php?quantityProductInRow=4" class="btn-view btn-view-4"></a>
                                    <?php
                                    } else if (isset($_SESSION['qtyProductInRow_usercategory']) && $_SESSION['qtyProductInRow_usercategory'] == 4) {
                                    ?>
                                        <a href="usercategory.php?quantityProductInRow=2" class="btn-view btn-view-2"></a>
                                        <a href="usercategory.php?quantityProductInRow=3" class="btn-view btn-view-3"></a>
                                        <a href="usercategory.php?quantityProductInRow=4" class="btn-view btn-view-4 active"></a>
                                    <?php
                                    } else {
                                    ?>
                                        <a href="usercategory.php?quantityProductInRow=2" class="btn-view btn-view-2"></a>
                        ...
                        <div class="row">
                            <?php
                            foreach ($productOfCategoryList as $item) :
                        ...
                        ?>
                            <div class="pagination">
                                ...
                                ?>
                                    <span class="next">
                                        <a href="usercategory.php?page=<?php if ($previous > 1) {
                                                                        $previous--;
                                                                    }
                                                                    echo $previous ?>">←</a>
                                    </span>
                                ...
                                ?>
                                        <span class="page current">
                                            <a href="usercategory.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                                        </span>
                                    <?php
                                    } else {
                                    ?>
                                ...
                                ?>
                                    <span class="next">
                                        <a href="usercategory.php?page=<?php if ($next < $totalPage) {
                                                                        $next++;
                                                                    }
                                                                    echo $next ?>">→</a>
                                    </span>
