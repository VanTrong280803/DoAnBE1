...
if (isset($_SESSION['qtyProductInRow_findProduct']))
  unset($_SESSION['qtyProductInRow_findProduct']);
if (isset($_SESSION['findSort']))
  unset($_SESSION['findSort']);
...
if (isset($_SESSION['category'])) {
  ...
  if (isset($_GET['quantityProductInRow'])) {
    $_SESSION['qtyProductInRow_category'] = $_GET['quantityProductInRow'];
  }

  if (isset($_SESSION['qtyProductInRow_category'])) {
    if ($_SESSION['qtyProductInRow_category'] == 2) {
      $perpage = 4;
    } else if ($_SESSION['qtyProductInRow_category'] == 3) {
      $perpage = 6;
    }
  }
  ...
  if (isset($_GET['sort'])) {
    $_SESSION['categorySort'] = $_GET['sort'];
    if ($_GET['sort'] == 1) {
  ...
  } else if (isset($_SESSION['categorySort'])) {
    if ($_SESSION['categorySort'] == 1) {
      $productOfCategoryList = $productModel->getProductsCategorySortUpFollowPrice($id, $page, $perpage);
    } else if ($_SESSION['categorySort'] == 2) {
      $productOfCategoryList = $productModel->getProductsCategorySortDownFollowPrice($id, $page, $perpage);
    } else if ($_SESSION['categorySort'] == 3) {
      $productOfCategoryList = $productModel->getProductsCategorySortUpFollowStar($id, $page, $perpage);
    } else if ($_SESSION['categorySort'] == 4) {
      $productOfCategoryList = $productModel->getProductsCategorySortDownFollowStar($id, $page, $perpage);
    } else {
      $productOfCategoryList = $productModel->getProductInCategoryByPage($page, $perpage, $id);
    }
...
$productOfCategoryList = $categoryModel->getProductsByCategoryAndKeyword($categoryId, $keyword);
          ...
          <div class="col">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <li><a class="dropdown-item" href="category.php?sort=5">None <svg xmlns="http://www.w3.org/2000/svg"
                      width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                      <path
                        d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
                    </svg></a></li>
                <li><a class="dropdown-item" href="category.php?sort=1">Price: low to hight <svg
                      xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="bi bi-arrow-up" viewBox="0 0 16 16">
                      <path fill-rule="evenodd"
                        d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z" />
                    </svg></a></li>
                <li><a class="dropdown-item" href="category.php?sort=2">Price: hight to low <svg
                      xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="bi bi-arrow-down" viewBox="0 0 16 16">
                      <path fill-rule="evenodd"
                        d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z" />
                    </svg></a></li>
                <li><a class="dropdown-item" href="category.php?sort=3">Star: low to hight <svg
                      xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="bi bi-arrow-up" viewBox="0 0 16 16">
                      <path fill-rule="evenodd"
                        d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z" />
                    </svg></a></li>
                <li><a class="dropdown-item" href="category.php?sort=4">Star: hight to low <svg
                      xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="bi bi-arrow-down" viewBox="0 0 16 16">
                      <path fill-rule="evenodd"
                        d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z" />
      ...
      <div class="row">
        <div class="col-md-2 col-12 js-sidebar">
          <div class="category">
            ...
            <div class="search-category input-group">
          ...
          <div class="product-style">
            <div class="product-menu">
              <div class="row">
                <div class="col">
                  <?php
                  if (isset($_SESSION['qtyProductInRow_category']) && $_SESSION['qtyProductInRow_category'] == 2) {
                    ?>
                    <a href="category.php?quantityProductInRow=2" class="btn-view btn-view-2 active"></a>
                    <a href="category.php?quantityProductInRow=3" class="btn-view btn-view-3"></a>
                    <a href="category.php?quantityProductInRow=4" class="btn-view btn-view-4"></a>
                    <?php
                  } else if (isset($_SESSION['qtyProductInRow_category']) && $_SESSION['qtyProductInRow_category'] == 3) {
                    ?>
                      <a href="category.php?quantityProductInRow=2" class="btn-view btn-view-2"></a>
                      <a href="category.php?quantityProductInRow=3" class="btn-view btn-view-3 active"></a>
                      <a href="category.php?quantityProductInRow=4" class="btn-view btn-view-4"></a>
                    <?php
                  } else if (isset($_SESSION['qtyProductInRow_category']) && $_SESSION['qtyProductInRow_category'] == 4) {
                    ?>
                        <a href="category.php?quantityProductInRow=2" class="btn-view btn-view-2"></a>
                        <a href="category.php?quantityProductInRow=3" class="btn-view btn-view-3"></a>
                        <a href="category.php?quantityProductInRow=4" class="btn-view btn-view-4 active"></a>
                    <?php
                  } else {
                    ?>
                        <a href="category.php?quantityProductInRow=2" class="btn-view btn-view-2"></a>
                ...
                <div class="col">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                      <li><a class="dropdown-item" href="category.php?sort=5">None <svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <?php if (!empty($productOfCategoryList)): ?>
              <div class="row">
                <?php
            ...
            if ($totalPage > 1) {
              ...
              <div class="pagination">
                ...
                if ($page > 1) {
                  ?>
                  <span class="next">
                    <a href="category.php?page=<?php if ($previous > 1) {
                      $previous--;
                    }
                    echo $previous ?>">←</a>
                  </span>
                ...
                if ($page < $totalPage) {
                  ?>
                  <span class="next">
                    <a href="category.php?page=<?php if ($next < $totalPage) {
                      $next++;
                    }
                    echo $next ?>">→</a>
                  </span>
