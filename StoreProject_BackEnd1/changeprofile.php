...
if(isset($_SESSION['user']))
{
    ...
    {
        $path_avatar = "assets/img/avatar/" . $_FILES['avatar']['name'];
        ...
        $userModel->editInfoUser($_SESSION['user'], $fullname, $email, $phone, $avatar);
                                            ...
                                            <li class="header__cart-item">
                                                ...
                                                <div class="header__cart-item-info">
                                                    ...
                                                    <div class="header__cart-item-body">
                                                        ...
                                                        <a href="changeprofile.php?idDeleteProduct=<?php echo $element['id']?>"
